...
namespace wns { namespace ldk { namespace tests {
	...
	class RandomAccessLinkTest :
		public wns::TestFixture
	{
		CPPUNIT_TEST_SUITE( RandomAccessLinkTest );
...
CPPUNIT_TEST_SUITE_REGISTRATION( RandomAccessLinkTest );


void
RandomAccessLinkTest::prepare()
{
...
{
        CPPUNIT_ASSERT_EQUAL((unsigned long int)(0), candidate->size());
        candidate->add(fu1);
        CPPUNIT_ASSERT_EQUAL((unsigned long int)(1), candidate->size());
        candidate->add(fu2);
        CPPUNIT_ASSERT_EQUAL((unsigned long int)(2), candidate->size());
} // testAdd


void
RandomAccessLinkTest::testClear()
{
        candidate->add(fu1);
        candidate->add(fu2);
        candidate->clear();
