...
#ifndef WNS_SCHEDULER_STRATEGY_APCSTRATEGY_APCSLAVE_HPP
#define WNS_SCHEDULER_STRATEGY_APCSTRATEGY_APCSLAVE_HPP
...
namespace wns { namespace scheduler { namespace strategy { namespace apcstrategy {
	...
	{
	public:
		APCSlave(const wns::pyconfig::View& config);
		~APCSlave();
...
#endif // WNS_SCHEDULER_STRATEGY_APCSTRATEGY_APCSLAVE_HPP
