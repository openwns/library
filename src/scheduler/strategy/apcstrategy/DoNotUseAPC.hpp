...
#ifndef WNS_SCHEDULER_STRATEGY_APCSTRATEGY_DONOTUSEAPC_HPP
#define WNS_SCHEDULER_STRATEGY_APCSTRATEGY_DONOTUSEAPC_HPP
...
namespace wns { namespace scheduler { namespace strategy { namespace apcstrategy {
	...
	// Not Use APA strategy
	class DoNotUseAPC :
		public APCStrategy {
	public:
		DoNotUseAPC(const wns::pyconfig::View& config);
...
#endif // WNS_SCHEDULER_APASTRATEGY_DONOTUSEAPC_HPP
