...
#ifndef WNS_SCHEDULER_STRATEGY_STATICPRIORITY_HARQUPLINKSLAVERETRANSMISSION_HPP
#define WNS_SCHEDULER_STRATEGY_STATICPRIORITY_HARQUPLINKSLAVERETRANSMISSION_HPP
...
class HARQUplinkSlaveRetransmission:
    public SubStrategy
{
public:
...
private:
  ...
  void
  checkInputMap(SchedulerStatePtr schedulerState,
		wns::scheduler::SchedulingMapPtr schedulingMap) const;

  wns::scheduler::UserID
  getSourceUserID(SchedulerStatePtr schedulerState,
		  wns::scheduler::SchedulingMapPtr schedulingMap);

  int
  getProcessID(SchedulerStatePtr schedulerState,
	       wns::scheduler::SchedulingMapPtr schedulingMap);
...
#endif // WNS_SCHEDULER_STRATEGY_STATICPRIORITY_HARQUPLINKSLAVERETRANSMISSION_HPP
