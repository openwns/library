...
#ifndef WNS_SCHEDULER_STRATEGY_DSASTRATEGY_NEARBYFIRST_HPP
#define WNS_SCHEDULER_STRATEGY_DSASTRATEGY_NEARBYFIRST_HPP
...
namespace wns { namespace scheduler { namespace strategy { namespace dsastrategy {
    ...
    */
    class NearbyFirst : public DSAStrategy
    {
    public:
