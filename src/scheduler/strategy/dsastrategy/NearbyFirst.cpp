...
#include <WNS/scheduler/strategy/dsastrategy/NearbyFirst.hpp>
...
STATIC_FACTORY_REGISTER_WITH_CREATOR(NearbyFirst,
...
void
NearbyFirst::initialize(SchedulerStatePtr schedulerState,
                         SchedulingMapPtr schedulingMap)
{
	...
	std::map<double, wns::scheduler::UserID> userIdMap;
	...
	std::map<double, wns::scheduler::UserID>::iterator userIdMapIt;
...
////////////////////////////////////////////////////////////////////////////////////////
//	std::cout <<  "DEBUGGG: ABD  " 
//	<< "BS:  " << schedulerState->myUserID.getNode()->getName() 
//	<< "  mit ID:  " << schedulerState->myUserID.getNode()->getNodeID() << "\n";
...
/*	std::map<double, std::set<DSAResult>::iterator>::iterator resStartIt;
	...
	{
		MESSAGE_SINGLE(NORMAL, logger, "NearbyFirst::initialize:  "
			<< "Distanz zu BS : " << resAmountIt->first
			<< "  Ressourcen-Groesse: " << resAmountIt->second);
	}
*/
//	std::map<double, wns::scheduler::UserID>::iterator userIdMapIt;
//	for(userIdMapIt = userIdMap.begin(); userIdMapIt != userIdMap.end(); userIdMapIt++)
//	{
//			std::cout << "DEBUGGG: " 
//			<< "NearbyFirst::initialize:  "
//			<< "Distanz zu BS : " << userIdMapIt->first
//			<< " UserID: " << userIdMapIt->second.getNodeID() << "\n";
//	}
////////////////////////////////////////////////////////////////////////////////////////
...
DSAResult
NearbyFirst::getSubChannelWithDSA(RequestForResource& request,
...
////////////////////////////////////////////////////////////////////////////////////////
//		std::cout << "DEBUGGG: " 
//		<< "User: " << request.user.getNodeID() << " mit Distanz: " << distance 
//		<< " bekommt die Resource: " << dsaResultSetIt->subChannel << "." << dsaResultSetIt->timeSlot << "." << dsaResultSetIt->spatialLayer << "\n";
////////////////////////////////////////////////////////////////////////////////////////
...
/*    DSAResult resource;
    ...
    for(dsaResultSetIt = resStart_[distance]; i < max ; dsaResultSetIt++)
    {
        i++;
        if (channelIsUsable(dsaResultSetIt->subChannel, dsaResultSetIt->timeSlot, dsaResultSetIt->spatialLayer, request, schedulerState, schedulingMap))
        {
            resource.subChannel = dsaResultSetIt->subChannel;
            resource.timeSlot = dsaResultSetIt->timeSlot;
            resource.spatialLayer = dsaResultSetIt->spatialLayer;
    ...
    else
    {
        ...
        dsaResult = freeResources[rnd];

        MESSAGE_SINGLE(NORMAL, logger, "getSubChannelWithDSA(): Granting resource: "
            << dsaResult.subChannel << "." << dsaResult.timeSlot << "." 
            << dsaResult.spatialLayer << " to " << request.toString());
        return dsaResult;
    }*/
