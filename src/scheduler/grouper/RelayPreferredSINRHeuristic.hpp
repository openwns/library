...
#ifndef WNS_SCHEDULER_GROUPER_RELAYPREFERREDSINRHEURISTIC_HPP
#define WNS_SCHEDULER_GROUPER_RELAYPREFERREDSINRHEURISTIC_HPP

#include <WNS/scheduler/grouper/TreeBasedGrouper.hpp>

namespace wns { namespace scheduler { namespace grouper {
	class RelayPreferredSINRHeuristic :
		public TreeBasedGrouper
	{
	public:
		RelayPreferredSINRHeuristic(const wns::pyconfig::View& config);
...
#endif //WNS_SCHEDULER_GROUPER_RELAYPREFERREDSINRHEURISTIC_HPP
