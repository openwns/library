...
namespace wns { namespace scheduler { namespace queue {
	...
	*/
	...
	public:
		 ...
		 * @brief
		 *
		 * Returns a ConnectionSet of all connections with a certain
		 * priority who have backlogged PDUs in his queue.
		 */
		virtual ConnectionSet getActiveConnectionsForPriority(unsigned int priority) const = 0;
