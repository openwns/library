...
#ifndef WNS_PROBE_BUS_JSON_ELEMENTS_HPP
#define WNS_PROBE_BUS_JSON_ELEMENTS_HPP
...
#include <WNS/probe/bus/json/elementsInl.hpp>

#endif // WNS_PROBE_BUS_JSON_ELEMENTS_HPP
